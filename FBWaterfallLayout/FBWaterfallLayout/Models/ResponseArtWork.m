...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    if (copy) {
        ...
        copy.artWorkMovie = self.artWorkMovie;//[self.artWorkMovie copyWithZone:zone];
        copy.artWorkTitle = [self.artWorkTitle copyWithZone:zone];
        copy.lang = [self.lang copyWithZone:zone];
        copy.artWorkListImage = self.artWorkListImage;//[self.artWorkListImage copyWithZone:zone];
        copy.isActiveAdmin = self.isActiveAdmin;
        copy.isContest = self.isContest;
        copy.thumb = [self.thumb copyWithZone:zone];
        copy.artWorkType = self.artWorkType;
        copy.reserveDateSet = self.reserveDateSet;//[self.reserveDateSet copyWithZone:zone];
        copy.reserveHourSet = self.reserveHourSet;//[self.reserveHourSet copyWithZone:zone];
        copy.commentCount = self.commentCount;
        copy.selfInspection = self.selfInspection;//[self.selfInspection copyWithZone:zone];
        ...
        copy.selfInclude = self.selfInclude;//[self.selfInclude copyWithZone:zone];
        copy.like = self.like;
        copy.reserveMinuteSet = self.reserveMinuteSet;//[self.reserveMinuteSet copyWithZone:zone];
        ...
        copy.artWorkThumb = self.artWorkThumb;//[self.artWorkThumb copyWithZone:zone];
        copy.artWorkOpenDate = self.artWorkOpenDate;
        copy.reserveSet = self.reserveSet;
        copy.artWorkAttache = self.artWorkAttache;//[self.artWorkAttache copyWithZone:zone];
        copy.artWorkIdx = self.artWorkIdx;
        copy.artWorkHashTag = self.artWorkHashTag;//[self.artWorkHashTag copyWithZone:zone];
    }
